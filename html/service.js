            ...
            <div class="row">
               ...
               <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="service-wrap text-center">
                     ...
                     <h3>Ming Pool</h3>
                     <p>
                        Earn Bitcoin without self-mining. 
                     </p>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6 col-xs-12">
               ...
               <div class="col-md-12">
                  <div id="team-members" class="owl-carousel owl-theme">
                     <div class="team-member ">
                        <img src="img/miner01.png" alt="" class="img-responsive">
                        <div class="team-member-info text-center">
                           <h4 class="team-member-name">
                              S99 MAX.
                           </h4>
                           <ul class="social-list">
                              <li><a href="https://www.instagram.com/thor_miner/" class="social-icon icon-gray"><span class="fab fa-instagram"></span></a></li>
                              <li><a href="https://www.facebook.com/profile.php?id=100078178533864" class="social-icon icon-gray"><span class="fab fa-facebook"></span></a></li>
                           </ul>
                        </div>
                     </div>
                     <div class="team-member ">
                        <img src="img/miner02.png" alt="" class="img-responsive">
                        <div class="team-member-info text-center">
                           <h4 class="team-member-name">
                              S99 PRO
                           </h4>
                     ...
                     <div class="team-member ">
                        <img src="img/miner03.png" alt="" class="img-responsive" >
                        <div class="team-member-info text-center">
                           <h4 class="team-member-name">
                              S99 S
                           </h4>
